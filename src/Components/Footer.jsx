  ...
  const newsLetter=(e)=>{
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid  md:col-span-3  gap-y-6 md:gap-y-10 lg:gap-y-16 gap-x-12                grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            ...
            <span className='text-4xl'>#</span>ShareBite<span className="text-[#ff6d03] font-extrabold">.</span>
            </h1>
               </div>
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="https://web.facebook.com/" target='_blank' title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 ">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li>
                        <a href="https://www.instagram.com/" target='_blank' title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 ">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form onSubmit={newsLetter} className="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-5 py-3 mt-3 font-semibold text-white transition-all duration-200 bg-[#ff6d03] rounded-md hover:bg-[#ff7c47] ">Subscribe</button>
                </form>
            </div>
        </div>
        ...
        <p className="text-sm text-center ">© Copyright 2025, All Rights Reserved by ShareBite</p>
    </div>
</section>
